                ...
                if(isset($_POST['searchquery']) && $_POST['searchquery'] != ""){
                    ...
                    if($_POST['Categoria'] != "all"){
                        ...
                        if($_POST['SottoCategoria'] == "all"){
                           ...
                           $sql = "SELECT annunci.* FROM annunci, sottocategory, macrocategory WHERE macrocategory.ID = ".$_POST['Categoria']." AND annunci.FKsottocategoria = sottocategory.ID AND sottocategory.FKcategory = macrocategory.ID ";

                        } else {

                            $sql = "SELECT annunci.* FROM annunci, sottocategory, macrocategory WHERE macrocategory.ID = ".$_POST['Categoria']." AND sottocategory.ID = ".$_POST['SottoCategoria']." AND annunci.FKsottocategoria = sottocategory.ID AND sottocategory.FKcategory = macrocategory.ID ";
